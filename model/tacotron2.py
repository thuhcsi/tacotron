...
""" with n_frame_per_step>1 support from https://github.com/NVIDIA/tacotron2/pull/404 (https://github.com/Jeevesh8/tacotron2)"""
...
class Tacotron2(nn.Module):
    ...
    def parse_data_batch(self, batch):
        ...
        return (
            ...
            (mel_padded, mel_padded, gate_padded))
...
class Tacotron2Loss(torch.nn.Module):
    ...
    def forward(self, model_output, targets):
        mel_target, _, gate_target = targets
